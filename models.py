"""
    This module used to implement the Stockfish class,
    some heavy-handed alterations have been made to implement lc0 instead.

    :copyright: (c) used to be 2016-2021 by Ilya Zhelyabuzhsky, now not copyright 2022 Nihal Gulati.
...
class Engine:
    ...
    def __init__(
        ...
        try:
            ...
            self._stockfish_major_version = 0
